...
from gate_set_tomography import prepare_states, measurement_basis, GST_execute_circuit, GST, GST_basis_operations
from qibo.noise import NoiseModel, PauliError, DepolarizingError, AmplitudeDampingError
import pytest
import qibo
...
def test_GST_basis_operations_with_inputs_one_qubit():
	...
	output1, output2, output3 = GST_basis_operations(nqubits=1, gjk=gjk1, nshots=1000, noise_model=depol)
...
def test_GST_basis_operations_with_inputs_two_qubit():
	...
	output1, output2, output3 = GST_basis_operations(nqubits=2, gjk=gjk2, nshots=1000, noise_model=depol)
