...
from qibo.derivative import parameter_shift, stochastic_parameter_shift, finite_differences
...
def test_psr(backend, nshots, atol, scale_factor, grads):
...
def test_numerical_differences(backend, nshots, atol):
