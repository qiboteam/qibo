...
def test_GST_execute_circuit_1qb_jnonzero(backend, k, j):
    ...
    backend.assert_allclose(test_result, control_result, rtol=1e-2, atol=1e-2)
...
def test_GST_one_qubit_empty_circuit(backend):
    ...
    backend.assert_allclose(control_result, test_result, rtol=1e-2, atol=1e-2)
...
def test_GST_one_qubit_with_Hgate(backend):
    ...
    backend.assert_allclose(control_result, test_result)
