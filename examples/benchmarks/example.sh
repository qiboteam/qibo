...
do
  ...
  python main.py --circuit qft --nqubits $NQUBITS --filename $FILENAME --dtype "complex64"
  python main.py --circuit variational --nqubits $NQUBITS --filename $FILENAME
  python main.py --circuit variational --nqubits $NQUBITS --filename $FILENAME --dtype "complex64"
done
python main.py --circuit qft --nqubits 31 --filename $FILENAME --dtype "complex64"
python main.py --circuit variational --nqubits 31 --filename $FILENAME --dtype "complex64"
...
python main.py --circuit qft --nqubits 32 --filename $FILENAME --device "/CPU:0" --accelerators $ACCEL --dtype "complex64"
...
python main.py --circuit qft --nqubits 33 --filename $FILENAME --device "/CPU:0" --accelerators $ACCEL --dtype "complex64"
...
python main.py --circuit qft --nqubits 34 --filename $FILENAME --device "/CPU:0" --accelerators $ACCEL --dtype "complex64"
