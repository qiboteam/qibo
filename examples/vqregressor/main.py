...
parser.add_argument(
    "--learning_rate", default=0.045, help="Learning rate for the Adam Descent", type=float
)
parser.add_argument(
    "--epochs", default=150, help="Number of training epochs", type=int
)
parser.add_argument(
    "--batches", default=1, help="Number of batches which divide the training sample", type=int
)
parser.add_argument(
...
def main(layers, learning_rate, epochs, batches, ndata, J_treshold):
    ...
    vqr.train_with_psr(epochs = epochs, learning_rate = learning_rate, batches = batches, J_treshold = J_treshold)
