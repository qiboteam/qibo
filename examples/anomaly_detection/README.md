...
Code at: [https://github.com/qiboteam/qibo/tree/main/examples/anomaly_detection](https://github.com/qiboteam/qibo/tree/main/examples/anomaly_detection).
...
Training has been performed for 20 epochs using [Adam optimizer](https://arxiv.org/abs/1412.6980), with a dynamic learning rate that spans from 0.4 in the first epochs to 0.001 in the last ones. This variable learning rate has helped reducing the problem of [barren plateaus](https://arxiv.org/abs/1803.11173).
