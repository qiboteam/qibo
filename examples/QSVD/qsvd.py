...
class QSVD():
    ...
    def minimize(self, init_theta, nlayers, init_state=None, nshots=100000,
        ...
        result = minimize(self.QSVD_cost, init_theta, args=(nlayers,init_state,nshots,RY), method=method, options={'disp':True})
        loss = result.fun
    ...
    def VonNeumann_entropy(self, theta, nlayers, init_state, tol=1e-14, nshots=100000, RY=False):
        ...
        Schmidt = self.Schmidt_coeff(theta, nlayers, init_state, nshots=nshots, RY=RY)       
        Schmidt = Schmidt**2
