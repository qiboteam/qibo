...
def GST_1qb(NshotsGST=1e4, noise_model=None, save_data=None, class_qubit_gate=None, theta=None, operator_name=None, backend=None):
...
def GST_2qb(NshotsGST=1e4, noise_model=None, save_data=None, class_qubit_gate=None, ctrl_qb=None, targ_qb=None, theta=None, operator_name=None, backend=None):
...
def GST_1qb_basis_operations(NshotsGST=1e4, noise_model=None, gjk_1qb=None, save_data=None, backend=None):
    ...
    BasisOps_13 = [np.matrix(gates.I(0).matrix(backend=GlobalBackend())),
...
def GST_2qb_basis_operations(NshotsGST=1e4, noise_model=None, gjk_2qb=None, save_data=None, backend=None):
    """Runs gate set tomography for the 13 basis operations for a single qubit.
    ...
    for idx_basis_ops_72 in range(169,241):
        ...
        for k in range(0,16):
            ...
            circ.add(gates.Unitary(BasisOps_241[idx_basis_ops_72], 1,0, trainable=False, name='%s' %(idx_basis_ops_72)))
