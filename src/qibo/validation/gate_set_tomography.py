        ...
        if nqubits == 1:
            ...
            for idx_basis_ops in range(0,13):
                ...
                for k in range(0,4):
                    ...
                    if  idx_basis_ops < 10:
                        circ.add(gates.Unitary(BO_1qb[idx_basis_ops], 0, trainable=False, name='%s' %(gatenames_1qb[idx_basis_ops])))
                ...
                for idx_gatenames_2 in range(0,13):
                    ...
                    for k in range(0,16):
                        ...
                        if  idx_gatenames_1 < 10 and idx_gatenames_2 < 10: ### NEW SCENARIO 1
                            circ.add(gates.Unitary(BO_1qb[idx_gatenames_1], 0, trainable=False, name='%s' %(gatenames_2qb[idx_basis_ops])))
                            circ.add(gates.Unitary(BO_1qb[idx_gatenames_2], 1, trainable=False, name='%s' %(gatenames_2qb[idx_basis_ops])))
            ...
            for idx_basis_ops in range(169,241):
                ...
                for k in range(0,16):
                    ...
                    # 72 Basis operations
                    circ.add(gates.Unitary(BO_2qb[idx_basis_ops], 0,1, trainable=False, name='%s' %(gatenames_2qb[idx_basis_ops])))
