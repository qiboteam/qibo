...
def test_default_qgan():
    ...
    train_qGAN = models.StyleQGAN(latent_dim=latent_dim, layers=layers, n_epochs=1)
...
def test_custom_qgan():
    ...
    train_qGAN = models.StyleQGAN(latent_dim=latent_dim, circuit=circuit, set_parameters=set_params,
