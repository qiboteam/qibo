...
def _binary_encoder_hopf(
    ...
    **kwargs,
    ...
    angles = backend.where(backend.isnan(angles), 0.0, angles)
...
def _hamming_weight_encoder_deprecated(
    data: ArrayLike,
    nqubits: int,
    weight: int,
    full_hwp: bool = False,
