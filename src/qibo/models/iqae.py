...
class IterativeAmplitudeEstimationResult:
    ...
    def __init__(self):
        ...
        self._epsilon_target: float = None
        self._epsilon_estimated: float = None
        self._num_oracle_queries: float = None
        self._estimation: float = None
        self._estimate_intervals: list[list[float]] = None
        self._theta_intervals: list[list[float]] = None
        self._k_list: list[int] = None
        self._ratios: list[float] = None
        self._shots: list[int] = None
