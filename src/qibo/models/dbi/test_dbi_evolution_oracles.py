...
h_input = SymbolicHamiltonian(
    symbols.X(0) + symbols.Z(0) * symbols.X(1) + symbols.Y(2), nqubits=3
)
...
input_hamiltonian_evolution_oracle.mode_evolution_oracle = (
    EvolutionOracleType.hamiltonian_simulation
)
...
query_list = gci.group_commutator_query_list(
    0.2, d_0, input_hamiltonian_evolution_oracle
)
